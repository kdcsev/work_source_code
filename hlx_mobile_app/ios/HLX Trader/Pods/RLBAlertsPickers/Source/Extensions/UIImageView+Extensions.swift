...
extension UIImageView {
    ...
    open func setImage(string: String?, color: UIColor? = nil, circular: Bool = false, textAttributes: [NSAttributedString.Key: AnyObject]? = nil) {
...
extension UIImageView {
    ...
    public func setImageForName(string: String, backgroundColor: UIColor? = nil, circular: Bool, textAttributes: [NSAttributedString.Key: AnyObject]? = nil, gradient: Bool = false, gradientColors: GradientColors? = nil) {
        ...
        let attributes: [NSAttributedString.Key: AnyObject] = textAttributes ?? [
            .font: self.fontForFontName(name: nil),
            .foregroundColor: UIColor.white
        ]
