...
class HelpTradeCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        let htmlString = Constants.videoHtml.replacingOccurrences(of: "{video_id}", with: Constants.helpVideoIds[0])
...
extension HelpTradeCell: WKNavigationDelegate {
